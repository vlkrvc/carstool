    ...
    <div className="min-h-screen bg-neutral-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="rounded-3xl border border-neutral-800/60 bg-gradient-to-br from-neutral-900/40 to-neutral-900/60 p-8 backdrop-blur-sm shadow-xl space-y-6">
          <div>
            <h1 className="text-2xl font-bold text-neutral-50 tracking-tight">Welcome back</h1>
            <p className="text-sm text-neutral-500 mt-1">Sign in to your garage</p>
          </div>
          ...
          <p className="text-sm text-neutral-500 text-center">
            ...
            <button onClick={onSwitchToRegister} className="text-amber-400 hover:text-amber-300 transition-colors">
              Create one
            </button>
          </p>
        </div>
